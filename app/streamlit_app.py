...
<style>
    ...
    .stTextArea > div > div > textarea:focus {
        ...
        box-shadow:
            0 0 0 3px rgba(218, 123, 147, 0.25),
            0 6px 28px rgba(0, 0, 0, 0.25) !important;
    }
    ...
    div[data-testid="stMetric"]:hover {
        ...
        box-shadow: 0 4px 24px rgba(218, 123, 147, 0.15);
    }
    ...
    .card:hover {
        border-color: rgba(218, 123, 147, 0.4);
    }
    .card h3 {
        margin: 0 0 14px 0;
        font-size: 12px;
    ...
    .hero {
        ...
        margin-bottom: 8px;
        letter-spacing: -1px;
        text-shadow: 0 0 40px rgba(218, 123, 147, 0.25);
    }
    .hero span {
    ...
    .pill-ok {
        background: rgba(55, 110, 111, 0.25);
        color: #5eead4;
    ...
    .pill-err {
        background: rgba(218, 123, 147, 0.2);
        color: #DA7B93;
    ...
    .empty {
        ...
        backdrop-filter: blur(14px);
        -webkit-backdrop-filter: blur(14px);
        border: 1.5px solid rgba(218, 123, 147, 0.3);
        border-radius: 20px;
    }
    .empty .icon {
        font-size: 48px;
        margin-bottom: 12px;
        filter: drop-shadow(0 0 16px rgba(218, 123, 147, 0.4));
    }
...
if generate:
    ...
    try:
        with st.spinner("Matching tracks & building roadmap..."):
            response = requests.post(f"{API_URL}/api/recommend", json=payload, timeout=30)
        ...
        st.error("FastAPI not running — start with: `uvicorn app.main:app --reload`")
